...
?>
  ...
  if (empty($_SESSION["pesanan"]) or !isset($_SESSION["pesanan"])) {
    echo "<script>alert('Pesanan kosong, Minimal pesan la boyy');</script>";
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid text-center">
      <div class="container">
        <h1 class="display-4"><span class="font-weight-bold">TOKO HOODIE</span></h1>
        <hr>
    ...
    <div class="container">
      ...
      if (isset($_POST['konfirm'])) {
        ...
        echo "<script>alert('Pemesanan Sukses, Thankyouu><');</script>";
        echo "<script>location= 'menu_pembeli.php'</script>";
      }
      ?>
    </div>
